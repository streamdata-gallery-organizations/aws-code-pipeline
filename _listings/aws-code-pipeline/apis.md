...
- name: AWS Code Pipeline API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-code-pipeline/master/_listings/aws-code-pipeline/action-updatepipeline-get.md
x-common:
- type: x-blog
